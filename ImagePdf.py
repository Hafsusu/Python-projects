...
class ImageToPdfConverter:
    ...
    def initialize_ui(self):
        ...
        self.selected-images_listbox.pack(pady =(0, 10), fill =tk.BOTH, expand = True)
        ...
        convert_button = tk.Button(self.root, text = "Convert to Pdf", command = self.convert_images_pdf)
        convert_button.pack(pady =(20 , 40))

    def select_images(self):
        self.image_paths = filedialog.askopenfilenames(title = "Selcet Images", filetypes = [("Image files", "*.png; *.jpg; *.jpeg")])
        self.update_selected_images_listbox()

    def update_selected_images_listbox(self):
        self.selected_images_listbox.delete(0, tk.END)

        for imag_path in self.image_paths:
